    ...
    <section className='update'>
        <div className="update-flex-one">
            ...
            <div className="update-right-one">
                ...
                <div>
                    ...
                    <p data-aos="fade-up">لدينا في هيدرا تي في تعمل علي تحديث باقتنا بشكل يومي وإضافة تحديثات الأفلام والمسلسلات الأجنبية وذلك رغبة في تقديم أفضل خدمة لعملائنا</p>
                </div>
            </div>
        </div>
        <div className="update-flex-two">
            <div className="update-left-two">
                ...
                <p data-aos="fade-up">نحقق في هيدرا المعادلة الصعبة , وهي جودة ممتازة مع خدمة مستقرة وتحديثات دائمة مع دعم فني وبسعر مناسب</p>                
            </div>
            <div className="update-center-two">
                <h2 className='sss' data-aos="fade-up">شهور هديه</h2>
                <p data-aos="fade-up">نقوم بتقديم شهور هديه في هيدرا وذلك لكل عملائنا الكرام علي خططنا السنوية أو النصف سنوية</p>
            </div>
    ...
    <section className='support'>
        <div className="support-flex">
            ...
            <div className="support-right">
                ...
                <p data-aos="fade-up">نوفر في اشتراك هيدرا افضل خدمة بعد البيع علي الإطلاق, حيث أن فريقنا مجهز علي أعلي مستوي لتقديم الدعم المناسب لك بعد البيع, وهذا من أهم مميزاتنا والتي نحافظ عليها, فريقنا متواجد علي مدار اليوم لخدمتك.</p>
            </div>
        </div>
    </section>
